...
import * as sty from "./PlasmicPageLayout.module.css"; // plasmic-import: cOyVv37Ms_ul/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: o3UCli0-KzD9/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 9XQBDa4sfV93/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__qv3Xg)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___7Aa6S)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__xf6E)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___7NGtv)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__d548Q)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
